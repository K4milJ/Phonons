...
"""
	calculate_matrix2d(N_x, N_y, M, Ω, C_3, positions)
...
"""
function calculate_matrix2d(N_x::Int, N_y::Int, M::Float64, Ω::Float64, C_3::Float64, positions::Array{Float64})
...
result_matrix = calculate_matrix2d(8, 10, 1.0, 1.0, 1.0, test_pos)
